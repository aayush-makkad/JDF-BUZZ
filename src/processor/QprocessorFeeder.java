...
import framework.core.jdbc.jdbcCore;
import mappedclass.engine.MappingEngine;
import xml.processing.XMLStorageListCreator;

public class QprocessorFeeder implements Runnable{

	@Override
	public void run() {
		// TODO Auto-generated method stub
		
		ArrayList<File> feed =new ArrayList<File>(MainProcessTypeSegragator.getQFiles());
...
//        System.out.println(element1.getAttribute("Name"));
		...
		if (node.getNodeType() == Node.ELEMENT_NODE) {
            ...
            cmd.setName(getTagValue("Class",element));
